...
At ${companyName}, we prioritize timely deliveries and customer satisfaction. We are working diligently to get your order to you as soon as possible.
...
We wanted to share some great news about your recent order (Order ID: ${orderId}) with ${companyName}! Your delivery, originating from ${routeInfo.originAddress}, is expected to arrive at ${routeInfo.destinationAddress} in just 74 minutes.

We’re committed to providing timely service and ensuring your satisfaction. Thank you for choosing ${companyName}!
